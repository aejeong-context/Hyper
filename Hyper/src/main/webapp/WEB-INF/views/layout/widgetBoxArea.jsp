<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<div class="widgetFunctionArea" id="widgetFunctionDay">디데이넣을거다.</div>
<div class="widgetFunctionArea" id="widgetFunctionMemo">메모넣을거다.</div>
...
<div class="widgetFunctionArea" id="widgetFunctionSign">
	<form id="sign" action="./register" method="post" onsubmit="return signSubmit()">
		<div class="fn-title">Hyper</div>
		<div class="form-login-low">
...
<div id="form-background" onmouseover="widgetOff()"></div>